    ...
    constructor(
        ...
        override suspend fun load(params: LoadParams<Int>): LoadResult<Int, MediaData> =
            try {
                ...
                val response = seriesApiService.searchTV(page = page, query = query)
                val result = seriesMapper.mapToData(response)
        ...
        @AssistedFactory
        interface Factory {
            fun create(query: String): SearchSeriesPagingSource
        }
    }
